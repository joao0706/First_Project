...
if (!is_array($usuario))
{
    ...
    echo "javascript:window.location='pizzas-cadastradas.php';</script>";
    exit;
}
?>
<!DOCTYPE html>
...
<body bgcolor="#FFFFFF" text="#000000">
	...
	<form action="edit_pizzas.php" name="editar_pizzas" method="POST">
						...
						<div class="card-body">
							<div class="form-group">
								<label for="nome">Nome</label> <input type="text"
									class="form-control" id="nome" name="nome" value="<?php echo $usuario['nome'] ?>">
							</div>
							<div class="form-group">
								<label for="descricao">Descricao</label> <input type="text"
									class="form-control" id="descricao" name="descricao" value="<?php echo $usuario['descricao'] ?>">
							</div>
							<div class="form-group">
								<label for="valor">Valor</label> <input type="text"
									class="form-control" id="valor" name="valor" value="<?php echo $usuario['valor'] ?>">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="card-footer" style="margin-left: 1%; margin-top: 15px">
			...
			<input type="submit" value="Alterar" class="btn btn-primary">Alterar</input>
		</div>
	</form>
</section>
 <?php
